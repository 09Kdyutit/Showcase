...
record('Free: 10 primary questions max', FREE_PLAN_LIMITS.maxPrimaryQuestions === 10)
...
record('Pro: 30 primary questions max', PRO_PLAN_LIMITS.maxPrimaryQuestions === 30)
