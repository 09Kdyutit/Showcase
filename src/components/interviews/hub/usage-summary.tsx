      ...
      <CardContent className="space-y-4">
        ...
        {usage.tier === 'free' && usage.sessions.remaining === 0 && (
          <div className="rounded-lg border border-border/60 bg-surface-100 p-3">
            ...
            <Button asChild size="sm" className="mt-3 h-auto min-h-8 whitespace-normal py-2 text-center">
              <Link href="/billing?plan=monthly&source=interview">Upgrade to Pro - $15/mo or $150/yr</Link>
            </Button>
          </div>
        )}
      </CardContent>
