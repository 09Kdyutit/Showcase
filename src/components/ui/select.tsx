...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between gap-2 rounded-xl border border-border bg-surface-100 px-3 py-2',
      'text-sm text-foreground placeholder:text-muted-foreground/60',
      'focus:outline-none focus:border-brand-500/60 focus:bg-surface-200',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'bg-surface-200 text-foreground shadow-premium',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-surface-400 focus:text-foreground',
