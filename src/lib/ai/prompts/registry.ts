...
// Quota-bearing routes use the matching quota or durable feature-lease runner, while
// internal non-quota flows call runPrompt(REGISTRY.x, input) (see ../client.ts).
//
