          ...
          <div className="flex-1 space-y-4 text-center sm:text-left">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <div className="p-3 rounded-xl bg-emerald-500/5 border border-emerald-500/20">
                <p className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Role Fit</p>
              ...
              <div className="p-3 rounded-xl bg-amber-500/5 border border-amber-500/20 col-span-2 sm:col-span-1">
                <p className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Gaps Found</p>
          ...
          {FIXES.map((fix, i) => (
            <div key={fix.title} className="flex items-start gap-4 p-4 rounded-xl bg-surface-200/60 border border-border/40">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs font-bold text-brand-400 uppercase tracking-wider">Fix {i + 1}</span>
                </div>
