              ...
              <>
                ...
                <section>
                  ...
                  <div className="glass-card p-5 space-y-4">
                    ...
                    <div>
                      <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider block mb-1.5">Headline</label>
                      <div className="text-foreground/90 font-medium">Senior Product Designer · B2B SaaS & Design Systems</div>
                    </div>
                    <div>
                      <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider block mb-1.5">Positioning Statement</label>
                    ...
                    <div>
                      <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider block mb-1.5">Proof Metrics</label>
