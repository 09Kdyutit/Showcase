          ...
          <div className="flex overflow-x-auto">
            {tabs.map((tab) => (
              ...
              >
                {tab.label}
                {tab.id === 'weak-bullets' && (
                  <span className="ml-1.5 text-xs bg-amber-500/20 text-amber-400 px-1.5 py-0.5 rounded-full">3</span>
                )}
              </button>
            ))}
          </div>
                ...
                {SKILLS.map((skill) => (
                  <span
                    ...
                    className={cn(
                      ...
                      skill.level === 'Advanced' && 'bg-violet-500/10 border-violet-500/20 text-violet-400',
            ...
            {WEAK_BULLETS.map((bullet, i) => (
              ...
              >
                ...
                <div className="flex items-start gap-2 p-3 rounded-lg bg-emerald-500/5 border border-emerald-500/20">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-emerald-400 uppercase tracking-wider mb-1">Suggested Fix</p>
